...
`Practical Functional Programming` is the the `third part of the Functional Programming introduction` from my workshops, it is an interesting radical hands-on approach.
...
## FP Workshops:
* [Functional (Programming) mindset]<a href="https://tech.io/playgrounds/24002/functional-programming-mindset/introduction" target="_blank">Functional (Programming) mindset</a><br><br/>
